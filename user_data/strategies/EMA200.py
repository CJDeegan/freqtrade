...
class EMA200(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['ema140'] = ta.EMA(dataframe, timeperiod=140)
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                (dataframe['ema18'] < dataframe['close']) &
                (dataframe['ema36'] < dataframe['close']) &
                (dataframe['ema140'] < dataframe['close']) &
                (dataframe['ema200'] < dataframe['close']) &
                (dataframe['ema18'] > dataframe['ema36'])
